...
<!--header/nav end-->
<!--video-list-frame start-->
<div class="container " style="background: #ffffff;margin-top: 70px;padding: 10px">
    <div class="video-list-title">
        <img src="../images/line.png">
        <span><a href="#">${videoType}</a></span>
        <hr style="margin-top:5px;margin-bottom: 10px; border-top-color: #cccccc">
    </div>
