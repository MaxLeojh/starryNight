        ...
        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div class="media">
                <div class="media-left">
                    <a href="#">
                        <img class="media-object img-responsive person-pic" src="../image/${directorPortrait}">
                    </a>
                </div>
                <div class="media-body">
                    <h4 class="media-heading" style="color: #336699">${directorName}</h4>
                    <div class="person-information">
                        <p class="row">
                            <span class="col-xs-12 col-sm-6 col-md-3 col-lg-3">性别：<span>${directorGender}</span></span>
                            <span class="col-xs-12 col-sm-6 col-md-3 col-lg-3">国籍：<span>${directorNation}</span></span>
                            <span class="col-xs-12 col-sm-6 col-md-3 col-lg-3">民族：<span>${directorEthnicGroup}</span></span>
                            <span class="col-xs-12 col-sm-6 col-md-3 col-lg-3">生日：<span>${directorBirth}</span></span>
                        </p>
                        <p class="row">
                            <span class="col-xs-12 col-sm-6 col-md-3 col-lg-3">奖项：<span>${directorAward}</span></span>
                        </p>
                        <p class="row">
                            <span class="col-xs-12 col-sm-12 col-md-12 col-lg-12">个人简介：<span>${directorReasume}</span></span>
                        </p>
                    </div>
                </div>
            </div>
